			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="kind_neu_test.php" class=""><i class="lnr lnr-code"></i> <span>Kind Anlegen</span></a></li>
						...
						<li><a href="Benutzer_Anlegen.php" class="active"><i class="lnr lnr-user"></i> <span>Benutzer Anlegen</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
