						...
						<div class="content">
							...
							<form class="form-auth-small" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
								<div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
									...
									<input type="text" name="signin-email" class="form-control" id="signin-email" placeholder="Benutzername" 
										value="<?php if(!empty($username)) echo $username; elseif(isset($_COOKIE["username"])) echo $_COOKIE["username"]; else echo ""; ?>">
